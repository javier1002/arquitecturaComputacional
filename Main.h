...
/**
 * @struct  LoginState
 * @brief define los diferentes estados que puede tener el sistema de alarma
 */
* @return 
enum LoginState
{
...
/**
 * @struct  Input
 * define los diferentes estados que puede tener el sistema de alarma en función de la entrada.
 */
enum Input
{
